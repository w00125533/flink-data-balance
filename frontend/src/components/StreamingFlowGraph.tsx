...
const nodePositions: Record<string, { x: number; y: number; group: string }> = {
  ...
  'kpi-1m': { x: 1544, y: 128, group: 'KPI' },
  'kpi-5m': { x: 1544, y: 404, group: 'KPI' },
  'kafka-kpi-1m': { x: 1922, y: 36, group: 'Sink' },
  'starrocks-kpi-1m': { x: 1922, y: 220, group: 'Sink' },
  'hive-kpi-1m': { x: 1922, y: 404, group: 'Sink' },
  'iceberg-kpi-1m': { x: 1922, y: 588, group: 'Sink' },
  'kafka-kpi-5m': { x: 1922, y: 772, group: 'Sink' },
  'starrocks-kpi-5m': { x: 1922, y: 956, group: 'Sink' },
  'hive-kpi-5m': { x: 1922, y: 1140, group: 'Sink' },
  'iceberg-kpi-5m': { x: 1922, y: 1324, group: 'Sink' },
  'kafka-cell-anomaly': { x: 2300, y: 36, group: 'Sink' },
  'kafka-user-anomaly': { x: 2300, y: 220, group: 'Sink' },
  'kafka-grid-anomaly': { x: 2300, y: 404, group: 'Sink' },
  'starrocks-cell-anomaly': { x: 2300, y: 588, group: 'Sink' },
  'starrocks-user-anomaly': { x: 2300, y: 772, group: 'Sink' },
  'starrocks-grid-anomaly': { x: 2300, y: 956, group: 'Sink' },
  'hive-cell-anomaly': { x: 2300, y: 1140, group: 'Sink' },
  'hive-user-anomaly': { x: 2300, y: 1324, group: 'Sink' },
  'hive-grid-anomaly': { x: 2300, y: 1508, group: 'Sink' },
  'iceberg-cell-anomaly': { x: 2300, y: 1692, group: 'Sink' },
  'iceberg-user-anomaly': { x: 2300, y: 1876, group: 'Sink' },
  'iceberg-grid-anomaly': { x: 2300, y: 2060, group: 'Sink' }
};
