...
class CellKpiIcebergMapperTest {
    ...
    void maps_cell_kpi_to_row_data_with_utc_partitions() throws Exception {
        ...
        assertThat(row.getFloat(7)).isEqualTo(-95.5f);
        assertThat(row.getFloat(8)).isEqualTo(12.25f);
        assertThat(row.getFloat(9)).isEqualTo(45.5f);
        assertThat(row.getFloat(10)).isEqualTo(88.75f);
