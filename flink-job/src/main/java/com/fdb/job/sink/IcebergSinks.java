...
public final class IcebergSinks {
    ...
    static Schema cellKpiSchema() {
        return new Schema(
            ...
            Types.NestedField.required(3, "source_event_ts_avg", Types.LongType.get()),
            Types.NestedField.required(4, "source_event_ts_min", Types.LongType.get()),
            Types.NestedField.required(5, "source_event_ts_max", Types.LongType.get()),
            Types.NestedField.required(6, "source_event_count", Types.LongType.get()),
            Types.NestedField.required(7, "site_id", Types.StringType.get()),
            Types.NestedField.required(8, "cell_id", Types.StringType.get()),
            Types.NestedField.required(9, "grid_id", Types.StringType.get()),
            Types.NestedField.required(10, "num_chr_events", Types.LongType.get()),
            Types.NestedField.required(11, "num_users", Types.LongType.get()),
            Types.NestedField.required(12, "rsrp_sample_count", Types.LongType.get()),
            Types.NestedField.required(13, "sinr_sample_count", Types.LongType.get()),
            Types.NestedField.required(14, "attach_attempts", Types.LongType.get()),
            Types.NestedField.required(15, "avg_rsrp", Types.FloatType.get()),
            Types.NestedField.required(16, "avg_sinr", Types.FloatType.get()),
            Types.NestedField.required(17, "avg_prb_usage_dl", Types.FloatType.get()),
            Types.NestedField.required(18, "throughput_dl_mbps_avg", Types.FloatType.get()),
            Types.NestedField.required(19, "drop_rate", Types.FloatType.get()),
            Types.NestedField.required(20, "ho_success_rate", Types.FloatType.get()),
            Types.NestedField.required(21, "attach_success_rate", Types.FloatType.get()),
            Types.NestedField.required(22, "join_quality", Types.StringType.get()),
            Types.NestedField.required(23, "window_kind", Types.StringType.get()),
            Types.NestedField.required(24, "dt", Types.StringType.get()),
            Types.NestedField.required(25, "hour", Types.StringType.get()));
    }
    ...
    static Schema anomalySchema() {
        return new Schema(
            ...
            Types.NestedField.required(5, "source_event_ts_max", Types.LongType.get()),
            Types.NestedField.required(6, "source_event_count", Types.LongType.get()),
            Types.NestedField.required(7, "entity_type", Types.StringType.get()),
            Types.NestedField.required(8, "entity_id", Types.StringType.get()),
            Types.NestedField.required(9, "window_start_ts", Types.LongType.get()),
            Types.NestedField.required(10, "window_end_ts", Types.LongType.get()),
            Types.NestedField.optional(11, "imsi", Types.StringType.get()),
            Types.NestedField.optional(12, "site_id", Types.StringType.get()),
            Types.NestedField.optional(13, "cell_id", Types.StringType.get()),
            Types.NestedField.optional(14, "grid_id", Types.StringType.get()),
            Types.NestedField.optional(15, "latitude", Types.DoubleType.get()),
            Types.NestedField.optional(16, "longitude", Types.DoubleType.get()),
            Types.NestedField.required(17, "anomaly_type", Types.StringType.get()),
            Types.NestedField.required(18, "severity", Types.StringType.get()),
            Types.NestedField.required(19, "rule_version", Types.StringType.get()),
            Types.NestedField.required(20, "context_json", Types.StringType.get()),
            Types.NestedField.required(21, "dt", Types.StringType.get()),
            Types.NestedField.required(22, "hour", Types.StringType.get()));
    }
